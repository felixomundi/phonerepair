    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            ...
            <?php
                ...
                <p class="mb-4">You can reach us through any of the following means</p>
                ...
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+254 <?php echo htmlentities($result->mobile);}} ?></p>
            </div>
