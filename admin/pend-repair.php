...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = $_POST['status'];  
         ...
         echo "<script>alert('Details changed successfully');document.location = 'pending-repairs.php';</script>";
     }
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Pending Repair Details</h4>
                    </div>
                ...
                <div class="row">
                  ...
                  ?>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                        <select class="form-control" disabled name="pid" id="product">
					...
					?>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                        <select class="form-control" disabled name="sid" id="service">
