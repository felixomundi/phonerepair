            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">View Done Repair details</h4>
                    </div>
...
<?php
                                                $id = intval($_GET['id']);
                                                $sql1="SELECT repairs.*,users.lname,users.fname,product.pname,services.sname from repairs inner join users on users.id=repairs.userid inner join product on product.id=repairs.pid inner join services on services.id=repairs.sid and  repairs.id=:id";
...
<!--------->
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Payment Details</span></h5>
                <div class="bg-light p-30 mb-5">
